...
namespace _20200522.Migrations
{
    ...
    [Migration("20200522074357_personCourseDelete")]
    partial class personCourseDelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_20200522.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("_20200522.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_20200522.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("_20200522.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("_20200522.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_20200522.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("_20200522.Models.Course", b =>
                {
                    b.HasOne("_20200522.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("_20200522.Models.CourseInstructor", b =>
                {
                    b.HasOne("_20200522.Models.Course", "Course")
                    ...
                    b.HasOne("_20200522.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("_20200522.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("_20200522.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("_20200522.Models.OfficeAssignment", b =>
                {
                    b.HasOne("_20200522.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("_20200522.Models.OfficeAssignment", "InstructorId")
